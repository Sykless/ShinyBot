...
def isTrainerOnBike(trainerPosition):
    ...
    if (cellValue in ["O","G","A"]):
        ...
        playerOrientation, spritePosition = getPlayerOrientation(getScreenshot())
        ...
        newSpritePosition = getPlayerOrientation(getScreenshot())[1]
