...
NORTH = Zone("North", FRIMAPIC_ID, "overworld/north", False, True, False, False)
NORTHCENTER = Zone("Northcenter", BONVILLE_ID, "overworld/northcenter", True, True, False, False)
NORTHEAST = Zone("Northeast", PARADISFLEURI_ID, "overworld/northeast", True, True, False, False)
NORTHWEST = Zone("Northwest", FLORAVILLE_ID, "overworld/northwest", True, True, False, False)
SOUTH = Zone("South", VERCHAMPS_ID, "overworld/south", True, True, False, False)
SOUTHCENTER = Zone("Southcenter", CHARBOURG_ID, "overworld/southcenter", True, True, False, False)
SOUTHEAST = Zone("Southeast", RIVELACCOURAGE_ID, "overworld/southeast", True, True, False, False)
SOUTHWEST = Zone("Southwest", BONAUGURE_ID, "overworld/southwest", True, True, False, False)
SECTEURCOMBAT_NORTHWEST = Zone("Secteur Combat - Northwest", AIREDESURVIE_ID, "overworld/secteurCombat-northwest", True, True, False, False)
SECTEURCOMBAT_SOUTHEAST = Zone("Secteur Combat - Southeast", AIREDECOMBAT_ID, "overworld/secteurCombat-southeast", True, True, False, False)

# Bonaugure
BONAUGURE = SubZone("Bonaugure", 411, (96,864), (127,895))
BONAUGURE.setEncounterTables(encounter.BONAUGURE)
BONAUGURE_MAISON = Zone("Bonaugure - Maison Maman", 414, "city/bonaugure-maisonMaman", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(116,885,SOUTHWEST), Position(6,10,BONAUGURE_MAISON)), Door(DOOR, Position(6,11,BONAUGURE_MAISON), Position(116,886,SOUTHWEST)))

# Littorella
LITTORELLA = SubZone("Littorella", 418, (160,832), (191,863))
LITTORELLA_CENTREPOKEMON = Zone("Littorella - Centre Pokémon", 420, "city/littorella-centrePokemon", False, False, False, False)
LITTORELLA_CENTREPOKEMON_ETAGE = Zone("Littorella - Centre Pokémon - Étage", 421, "city/littorella-centrePokemon-etage", False, False, False, False)
LITTORELLA_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
LITTORELLA_SHOP = Zone("Littorella - Shop", 419, "city/littorella-shop", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(177,842,SOUTHWEST), Position(8,12,LITTORELLA_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,LITTORELLA_CENTREPOKEMON), Position(177,843,SOUTHWEST)))
...
FELICITE_CENTREPOKEMON = Zone("Féli-Cité - Centre Pokémon", 6, "city/felicite-centrePokemon", False, False, False, False)
FELICITE_CENTREPOKEMON_ETAGE = Zone("Féli-Cité - Centre Pokémon - Étage", 7, "city/centrePokemon-etage", False, False, False, False)
FELICITE_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
FELICITE_SHOP = Zone("Féli-Cité - Shop", 4, "city/felicite-shop", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(180,776,SOUTHWEST), Position(8,12,FELICITE_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,FELICITE_CENTREPOKEMON), Position(180,777,SOUTHWEST)))
...
CHARBOURG_CENTREPOKEMON = Zone("Charbourg - Centre Pokémon", 48, "city/charbourg-centrePokemon", False, False, False, False)
CHARBOURG_CENTREPOKEMON_ETAGE = Zone("Charbourg - Centre Pokémon - Étage", 49, "city/centrePokemon-etage", False, False, False, False)
CHARBOURG_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
CHARBOURG_SHOP = Zone("Charbourg - Shop", 46, "city/charbourg-shop", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(303,756,SOUTHCENTER), Position(8,12,CHARBOURG_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,CHARBOURG_CENTREPOKEMON), Position(303,757,SOUTHCENTER)))
...
FLORAVILLE_CENTREPOKEMON = Zone("Floraville - Centre Pokémon", 428, "city/floraville-centrePokemon", False, False, False, False)
FLORAVILLE_CENTREPOKEMON_ETAGE = Zone("Floraville - Centre Pokémon - Étage", 429, "city/centrePokemon-etage", False, False, False, False)
FLORAVILLE_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
FLORAVILLE_SHOP = Zone("Floraville - Shop", 427, "city/floraville-shop", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(176,666,NORTHWEST), Position(8,12,FLORAVILLE_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,FLORAVILLE_CENTREPOKEMON), Position(176,667,NORTHWEST)))
...
VESTIGION_CENTREPOKEMON = Zone("Vestigion - Centre Pokémon", 69, "city/vestigion-centrePokemon", False, False, False, False)
VESTIGION_CENTREPOKEMON_ETAGE = Zone("Vestigion - Centre Pokémon - Étage", 70, "city/vestigion-centrePokemon-etage", False, False, False, False)
VESTIGION_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
VESTIGION_SHOP = Zone("Vestigion - Shop", 66, "city/vestigion-shop", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(305,530,NORTHWEST), Position(8,12,VESTIGION_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,VESTIGION_CENTREPOKEMON), Position(305,531,NORTHWEST)))
...
# Unionpolis
UNIONPOLIS = Zone("Unionpolis", 86, "city/unionpolis", True, True, False, False)
UNIONPOLIS_CENTREPOKEMON = Zone("Unionpolis - Centre Pokémon", 101, "city/unionpolis-centrePokemon", False, False, False, False)
UNIONPOLIS_CENTREPOKEMON_ETAGE = Zone("Unionpolis - Centre Pokémon - Étage", 102, "city/centrePokemon-etage", False, False, False, False)
UNIONPOLIS_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
UNIONPOLIS_SHOP = Zone("Unionpolis - Shop", 87, "city/unionpolis-shop", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(465,697,UNIONPOLIS), Position(8,12,UNIONPOLIS_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,UNIONPOLIS_CENTREPOKEMON), Position(465,698,UNIONPOLIS)))
...
BONVILLE_CENTREPOKEMON = Zone("Bonville - Centre Pokémon", 435, "city/bonville-centrePokemon", False, False, False, False)
BONVILLE_CENTREPOKEMON_ETAGE = Zone("Bonville - Centre Pokémon - Étage", 436, "city/centrePokemon-etage", False, False, False, False)
BONVILLE_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
BONVILLE_SHOP = Zone("Bonville - Shop", 434, "city/bonville-shop", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(566,656,NORTHCENTER), Position(8,12,BONVILLE_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,BONVILLE_CENTREPOKEMON), Position(566,657,NORTHCENTER)))
...
# Voilaroc
VOILAROC = Zone("Voilaroc", 132, "city/voilaroc", True, True, False, False)
VOILAROC_CENTREPOKEMON = Zone("Voilaroc - Centre Pokémon", 134, "city/voilaroc-centrePokemon", False, False, False, False)
VOILAROC_CENTREPOKEMON_ETAGE = Zone("Voilaroc - Centre Pokémon - Étage", 135, "city/centrePokemon-etage", False, False, False, False)
VOILAROC_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
VOILAROC_CENTRECOMMERCIAL = Zone("Voilaroc - Centre Commercial", 137, "city/centreCommercial-1", False, False, False, False)
VOILAROC_CENTRECOMMERCIALETAGE1 = Zone("Voilaroc - Centre Commercial Étage 1", 138, "city/centreCommercial-2", False, False, False, False)
VOILAROC_CENTRECOMMERCIALETAGE2 = Zone("Voilaroc - Centre Commercial Étage 2", 139, "city/centreCommercial-3", False, False, False, False)
VOILAROC_CENTRECOMMERCIALETAGE3 = Zone("Voilaroc - Centre Commercial Étage 3", 140, "city/centreCommercial-4", False, False, False, False)
VOILAROC_CENTRECOMMERCIALETAGE4 = Zone("Voilaroc - Centre Commercial Étage 4", 141, "city/centreCommercial-5", False, False, False, False)
VOILAROC_CENTRECOMMERCIALASCENSEUR = Zone("Voilaroc - Centre Commercial Ascenseur", 142, "city/centreCommercial-7", False, False, False, False)
VOILAROC_CENTRECOMMERCIALSOUSSOL1 = Zone("Voilaroc - Centre Commercial Sous-Sol 1", 566, "city/centreCommercial-6", False, False, False, False)
...
setConnectingDoors(Door(DEFAULT, Position(717,611,VOILAROC), Position(8,12,VOILAROC_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,VOILAROC_CENTREPOKEMON), Position(717,612,VOILAROC)))
...
VERCHAMPS_CENTREPOKEMON = Zone("Verchamps - Centre Pokémon", 123, "city/verchamps-centrePokemon", False, False, False, False)
VERCHAMPS_CENTREPOKEMON_ETAGE = Zone("Verchamps - Centre Pokémon - Étage", 124, "city/verchamps-centrePokemon-etage", False, False, False, False)
VERCHAMPS_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
VERCHAMPS_SHOP = Zone("Verchamps - Shop", 121, "city/verchamps-shop", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(600,815,SOUTH), Position(8,12,VERCHAMPS_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,VERCHAMPS_CENTREPOKEMON), Position(600,816,SOUTH)))
...
CELESTIA_CENTREPOKEMON = Zone("Célestia - Centre Pokémon", 443, "city/celestia-centrePokemon", False, False, False, False)
CELESTIA_CENTREPOKEMON_ETAGE = Zone("Célestia - Centre Pokémon - Étage", 444, "city/centrePokemon-etage", False, False, False, False)
CELESTIA_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
CELESTIA_SHOP = Zone("Célestia - Shop", 446, "city/celestia-shop", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(472,538,NORTHCENTER), Position(8,12,CELESTIA_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,CELESTIA_CENTREPOKEMON), Position(472,539,NORTHCENTER)))
...
# Joliberges
JOLIBERGES = Zone("Joliberges", 33, "city/joliberges", True, True, False, False)
JOLIBERGES.setEncounterTables(encounter.JOLIBERGES)
JOLIBERGES_CENTREPOKEMON = Zone("Joliberges - Centre Pokémon", 36, "city/joliberges-centrePokemon", False, False, False, False)
JOLIBERGES_CENTREPOKEMON_ETAGE = Zone("Joliberges - Centre Pokémon - Étage", 37, "city/centrePokemon-etage", False, False, False, False)
JOLIBERGES_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
JOLIBERGES_SHOP = Zone("Joliberges - Shop", 34, "city/joliberges-shop", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(58,722,JOLIBERGES), Position(8,12,JOLIBERGES_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,JOLIBERGES_CENTREPOKEMON), Position(58,723,JOLIBERGES)))
...
FRIMAPIC_CENTREPOKEMON = Zone("Frimapic - Centre Pokémon", 168, "city/frimapic-centrePokemon", False, False, False, False)
FRIMAPIC_CENTREPOKEMON_ETAGE = Zone("Frimapic - Centre Pokémon - Étage", 169, "city/centrePokemon-etage", False, False, False, False)
FRIMAPIC_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
FRIMAPIC_SHOP = Zone("Frimapic - Shop", 166, "city/frimapic-shop", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(379,233,NORTH), Position(8,12,FRIMAPIC_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,FRIMAPIC_CENTREPOKEMON), Position(379,234,NORTH)))
...
RIVAMAR_CENTREPOKEMON = Zone("Rivamar - Centre Pokémon", 151, "city/rivamar-centrePokemon", False, False, False, False)
RIVAMAR_CENTREPOKEMON_ETAGE = Zone("Rivamar - Centre Pokemon - Étage", 152, "city/centrePokemon-etage", False, False, False, False)
RIVAMAR_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
RIVAMAR_SHOP = Zone("Rivamar - Shop", 153, "city/rivamar-shop", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(860,784,EAST), Position(8,12,RIVAMAR_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,RIVAMAR_CENTREPOKEMON), Position(860,785,EAST)))
...
setConnectingDoors(Door(DEFAULT, Position(842,598,EAST), Position(8,12,LIGUEPOKEMON_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,LIGUEPOKEMON_CENTREPOKEMON), Position(842,599,EAST)))
setConnectingDoors(Door(DEFAULT, Position(847,559,EAST), Position(11,11,LIGUEPOKEMON_INTERIEUR)), Door(WALK, Position(11,12,LIGUEPOKEMON_INTERIEUR), Position(847,560,EAST)))
...
# Parc des Amis
PARCDESAMIS = Zone("Parc des Amis", 393, "city/parcdesamis", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(306,909,SOUTHWEST), Position(7,19,PARCDESAMIS)), Door(WALK, Position(7,20,PARCDESAMIS), Position(306,910,SOUTHWEST)))

# Aire de Combat
AIREDECOMBAT = SubZone("Aire de Combat", 188, (608,416), (671,447))
AIREDECOMBAT_CENTREPOKEMON = Zone("Aire de Combat - Centre Pokémon", 189, "city/airedecombat-centrePokemon", False, False, False, False)
AIREDECOMBAT_CENTREPOKEMON_ETAGE = Zone("Aire de Combat - Centre Pokémon - Étage", 190, "city/centrePokemon-etage", False, False, False, False)
AIREDECOMBAT_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
AIREDECOMBAT_SHOP = Zone("Aire de Combat - Shop", 191, "city/airedecombat-shop", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(647,429,SECTEURCOMBAT_SOUTHEAST), Position(8,12,AIREDECOMBAT_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,AIREDECOMBAT_CENTREPOKEMON), Position(647,430,SECTEURCOMBAT_SOUTHEAST)))
...
AIREDESURVIE_CENTREPOKEMON = Zone("Aire de Survie - Centre Pokémon", 452, "city/airedesurvie-centrePokemon", False, False, False, False)
AIREDESURVIE_CENTREPOKEMON_ETAGE = Zone("Aire de Survie - Centre Pokemon - Étage", 453, "city/centrePokemon-etage", False, False, False, False)
AIREDESURVIE_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
AIREDESURVIE_SHOP = Zone("Aire de Survie - Shop", 451, "city/airedesurvie-shop", False, False, False, False)
setConnectingDoors(Door(DEFAULT, Position(659,338,SECTEURCOMBAT_NORTHWEST), Position(8,12,AIREDESURVIE_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,AIREDESURVIE_CENTREPOKEMON), Position(659,339,SECTEURCOMBAT_NORTHWEST)))
...
AIREDEDETENTE_CENTREPOKEMON = Zone("Aire de Détente - Centre Pokémon", 459, "city/airededetente-centrePokemon", False, False, False, False)
AIREDEDETENTE_CENTREPOKEMON_ETAGE = Zone("Aire de Détente - Centre Pokemon - Étage", 460, "city/centrePokemon-etage", False, False, False, False)
AIREDEDETENTE_CENTREPOKEMON_ETAGE.setInteractableList(((1,5),PC), ((7,5),UNIONROOM))
setConnectingDoors(Door(DEFAULT, Position(802,472,SECTEURCOMBAT_SOUTHEAST), Position(8,12,AIREDEDETENTE_CENTREPOKEMON)), Door(SLIDING_DOOR, Position(8,13,AIREDEDETENTE_CENTREPOKEMON), Position(802,473,SECTEURCOMBAT_SOUTHEAST)))
...
ROUTE208 = Zone("Route 208", 354, "route/route208", True, True, False, False)
...
ROUTE218 = Zone("Route 218", 388, "route/route218", True, True, False, False)
...
ROUTE206_PASSAGEVESTIGION = Zone("Route 206 - Passage Vestigion", 80, "route/route206-passageVestigion", True, False, False, False)
...
ROUTE206_PASSAGECHARBOURG = Zone("Route 206 - Passage Charbourg", 351, "route/route206-passageCharbourg", True, False, False, False)
...
ROUTE208_PASSAGEUNIONPOLIS = Zone("Route 208 - Passage Unionpolis", 109, "route/route208-passageUnionpolis", True, False, False, False)
...
ROUTE209_PASSAGEUNIONPOLIS = Zone("Route 209 - Passage Unionpolis", 110, "route/route209-passageUnionpolis", True, False, False, False)
...
ROUTE212_PASSAGEUNIONPOLIS = Zone("Route 212 - Passage Unionpolis", 111, "route/route212-passageUnionpolis", True, False, False, False)
...
ROUTE215_PASSAGEVOILAROC = Zone("Route 215 - Passage Voilaroc", 149, "route/route215-passageVoilaroc", True, False, False, False)
...
ROUTE214_PASSAGEVOILAROC = Zone("Route 214 - Passage Voilaroc", 381, "route/route214-passageVoilaroc", True, False, False, False)
...
ROUTE218_PASSAGEJOLIBERGES = Zone("Route 218 - Passage Joliberges", 390, "route/route218-passageJoliberges", True, False, False, False)
...
ROUTE222_PASSAGERIVAMAR = Zone("Route 222 - Passage Rivamar", 398, "route/route222-passageRivamar", True, False, False, False)
...
ROUTE225_PASSAGEAIREDECOMBAT = Zone("Route 225 - Passage Aire de Combat", 193, "route/route225-passageAiredecombat", True, False, False, False)
...
ROUTE226_PASSAGEROUTE228 = Zone("Route 226 - Passage Route 228", 501, "route/route226-passageRoute228", True, False, False, False)
...
# Entrée Charbourg
ENTREECHARBOURG = Zone("Entrée Charbourg", 258, "dungeon/entreeCharbourg-1", True, False, True, True)
ENTREECHARBOURG.setEncounterTables(encounter.ENTREECHARBOURG)
ENTREECHARBOURG_SOUSSOL = Zone("Entrée Charbourg - Sous-Sol", 259, "dungeon/entreeCharbourg-2", True, False, True, True)
...
# Mine Charbourg
MINECHARBOURG_ENTREE = Zone("Mine Charbourg - Entrée", 198, "dungeon/mineCharbourg-1", True, False, True, True)
MINECHARBOURG_ENTREE.setEncounterTables(encounter.MINECHARBOURG_ENTREE)
MINECHARBOURG = Zone("Mine Charbourg", 199, "dungeon/mineCharbourg-2", True, False, True, True)
...
# Chemin Rocheux
CHEMINROCHEUX = Zone("Chemin Rocheux", 254, "dungeon/cheminRocheux", True, False, True, True)
...
# Pré Floraville
PREFLORAVILLE = Zone("Pré Floraville", 256, "route/preFloraville", True, True, False, False)
setConnectingDoors(Door(DEFAULT, Position(162,641,NORTHWEST), Position(12,54,PREFLORAVILLE)), Door(WALK, Position(12,55,PREFLORAVILLE), Position(162,642,NORTHWEST)))
setConnectingDoors(Door(WALK, Position(180,613,NORTHWEST), Position(50,10,PREFLORAVILLE)), Door(DEFAULT, Position(50,9,PREFLORAVILLE), Position(180,612,NORTHWEST)))

# Forêt de Vestigion
FORETVESTIGION = Zone("Forêt de Vestigion", 203, "dungeon/foretVestigion", True, True, False, False)
...
# Vieux Château
VIEUXCHATEAU = Zone("Vieux Château", 295, "dungeon/vieuxChateau-1", False, False, False, False)
VIEUXCHATEAU.setEncounterTables(encounter.VIEUXCHATEAU)
VIEUXCHATEAU_SALLEAMANGER = Zone("Vieux Château - Salle à Manger", 296, "dungeon/vieuxChateau-2", False, False, False, False)
VIEUXCHATEAU_SALLEAMANGER.setEncounterTables(encounter.VIEUXCHATEAU)
VIEUXCHATEAU_AILES = Zone("Vieux Château - Ailes", 297, "dungeon/vieuxChateau-3", False, False, False, False)
VIEUXCHATEAU_AILES.setEncounterTables(encounter.VIEUXCHATEAU)
VIEUXCHATEAU_COULOIR = Zone("Vieux Château - Couloir", 298, "dungeon/vieuxChateau-4", False, False, False, False)
VIEUXCHATEAU_COULOIR.setEncounterTables(encounter.VIEUXCHATEAU)
VIEUXCHATEAU_CHAMBRE1 = Zone("Vieux Château - Chambre 1", 299, "dungeon/vieuxChateau-5", False, False, False, False)
VIEUXCHATEAU_CHAMBRE1.setEncounterTables(encounter.VIEUXCHATEAU)
VIEUXCHATEAU_CHAMBRE2 = Zone("Vieux Château - Chambre 2", 300, "dungeon/vieuxChateau-6", False, False, False, False)
VIEUXCHATEAU_CHAMBRE2.setEncounterTables(encounter.VIEUXCHATEAU)
VIEUXCHATEAU_CHAMBRE3 = Zone("Vieux Château - Chambre 3", 301, "dungeon/vieuxChateau-7", False, False, False, False)
VIEUXCHATEAU_CHAMBRE3.setEncounterTables(encounter.VIEUXCHATEAU)
VIEUXCHATEAU_CHAMBRE4 = Zone("Vieux Château - Chambre 4", 302, "dungeon/vieuxChateau-8", False, False, False, False)
VIEUXCHATEAU_CHAMBRE4.setEncounterTables(encounter.VIEUXCHATEAU_CHAMBRE4)
VIEUXCHATEAU_CHAMBRE5 = Zone("Vieux Château - Chambre 5", 303, "dungeon/vieuxChateau-9", False, False, False, False)
...
# Piste Cyclable
PISTECYCLABLE = Zone("Piste Cyclable", 350, "route/pisteCyclable", True, True, False, False)
...
# Grotte Revêche
GROTTEREVECHE = Zone("Grotte Revêche", 284, "dungeon/grotteReveche-1", True, False, True, True)
GROTTEREVECHE.setEncounterTables(encounter.GROTTEREVECHE)
GROTTEREVECHE_SOUSSOL = Zone("Grotte Revêche - Sous-Sol", 285, "dungeon/grotteReveche-2", True, False, True, True)
...
# Tour Perdue
TOURPERDUE_REZDECHAUSSEE = Zone("Tour Perdue - Rez-de-Chaussée", 357, "dungeon/tourPerdue-1", False, False, False, False)
TOURPERDUE_REZDECHAUSSEE.setEncounterTables(encounter.TOURPERDUE_REZDECHAUSSEE)
TOURPERDUE_ETAGE1 = Zone("Tour Perdue - Étage 1", 358, "dungeon/tourPerdue-2", False, False, False, False)
TOURPERDUE_ETAGE1.setEncounterTables(encounter.TOURPERDUE_REZDECHAUSSEE)
TOURPERDUE_ETAGE2 = Zone("Tour Perdue - Étage 2", 359, "dungeon/tourPerdue-3", False, False, False, False)
TOURPERDUE_ETAGE2.setEncounterTables(encounter.TOURPERDUE_ETAGE2)
TOURPERDUE_ETAGE3 = Zone("Tour Perdue - Étage 3", 360, "dungeon/tourPerdue-4", False, False, False, False)
TOURPERDUE_ETAGE3.setEncounterTables(encounter.TOURPERDUE_ETAGE3)
TOURPERDUE_ETAGE4 = Zone("Tour Perdue - Étage 4", 361, "dungeon/tourPerdue-5", False, False, False, False)
...
# Ruines Bonville
RUINESBONVILLE_ENTREE = Zone("Ruines Bonville - Entrée", 226, "dungeon/ruinesBonville-1", True, False, True, True)
RUINESBONVILLE_ENTREE_NORDOUEST = Zone("Ruines Bonville - Entrée Nord-Ouest", 228, "dungeon/ruinesBonville-2", True, False, True, True)
RUINESBONVILLE_ENTREE_NORDOUEST.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_ENTREE_SUDEST = Zone("Ruines Bonville - Entrée Sud-Est", 230, "dungeon/ruinesBonville-3", True, False, True, True)
RUINESBONVILLE_ENTREE_SUDEST.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE1 = Zone("Ruines Bonville - Salle 1", 229, "dungeon/ruinesBonville-4", True, False, True, True)
RUINESBONVILLE_SALLE1.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE1_NORDEST = Zone("Ruines Bonville - Salle 1 Nord-Est", 227, "dungeon/ruinesBonville-5", True, False, True, True)
RUINESBONVILLE_SALLE1_NORDEST.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE1_SUDEST = Zone("Ruines Bonville - Salle 1 Sud-Est", 232, "dungeon/ruinesBonville-6", True, False, True, True)
RUINESBONVILLE_SALLE1_SUDEST.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE2 = Zone("Ruines Bonville - Salle 2", 231, "dungeon/ruinesBonville-7", True, False, True, True)
RUINESBONVILLE_SALLE2.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE2_NORDOUEST = Zone("Ruines Bonville - Salle 2 Nord-Ouest", 235, "dungeon/ruinesBonville-8", True, False, True, True)
RUINESBONVILLE_SALLE2_NORDOUEST.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE2_SUDOUEST = Zone("Ruines Bonville - Salle 2 Sud-Ouest", 236, "dungeon/ruinesBonville-9", True, False, True, True)
RUINESBONVILLE_SALLE2_SUDOUEST.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE3 = Zone("Ruines Bonville - Salle 3", 237, "dungeon/ruinesBonville-10", True, False, True, True)
RUINESBONVILLE_SALLE3.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE3_SUDEST = Zone("Ruines Bonville - Salle 3 Sud-Est", 241, "dungeon/ruinesBonville-11", True, False, True, True)
RUINESBONVILLE_SALLE3_SUDEST.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE4 = Zone("Ruines Bonville - Salle 4", 239, "dungeon/ruinesBonville-12", True, False, True, True)
RUINESBONVILLE_SALLE4.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE4_SUDOUEST = Zone("Ruines Bonville - Salle 4 Sud-Ouest", 234, "dungeon/ruinesBonville-13", True, False, True, True)
RUINESBONVILLE_SALLE4_SUDOUEST.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE4_SUDEST = Zone("Ruines Bonville - Salle 4 Sud-Est", 515, "dungeon/ruinesBonville-14", True, False, True, True)
RUINESBONVILLE_SALLE4_SUDEST.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE5 = Zone("Ruines Bonville - Salle 5", 238, "dungeon/ruinesBonville-15", True, False, True, True)
RUINESBONVILLE_SALLE5.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE5_NORDOUEST = Zone("Ruines Bonville - Salle 5 Nord-Ouest", 242, "dungeon/ruinesBonville-16", True, False, True, True)
RUINESBONVILLE_SALLE5_NORDOUEST.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE5_SUDEST = Zone("Ruines Bonville - Salle 5 Sud-Est", 233, "dungeon/ruinesBonville-17", True, False, True, True)
RUINESBONVILLE_SALLE5_SUDEST.setEncounterTables(encounter.RUINESBONVILLE)
RUINESBONVILLE_SALLE6 = Zone("Ruines Bonville - Salle 6", 240, "dungeon/ruinesBonville-18", True, False, True, True)
...
# Tunnel Ruinemaniac
TUNNELRUINEMANIAC = Zone("Tunnel Ruinemaniac", 513, "dungeon/tunnelRuinemaniac", True, False, True, True)
TUNNELRUINEMANIAC.setEncounterTables(encounter.TUNNELRUINEMANIAC)
RUINESBONVILLE_SALLE7 = Zone("Ruines Bonville - Salle 7", 225, "dungeon/ruinesBonville-19", True, False, True, True)
...
# Mont Couronné
MONTCOURONNE_PASSAGECHARBOURG = Zone("Mont Couronné - Passage Charbourg", 207, "dungeon/montCouronne-1", True, False, True, True)
MONTCOURONNE_PASSAGECHARBOURG.setEncounterTables(encounter.MONTCOURONNE_PASSAGECHARBOURG)
MONTCOURONNE_SALLE1 = Zone("Mont Couronné - Salle 1", 208, "dungeon/montCouronne-2", True, False, True, True)
MONTCOURONNE_SALLE1.setEncounterTables(encounter.MONTCOURONNE_SALLE1)
MONTCOURONNE_SALLE2 = Zone("Mont Couronné - Salle 2", 209, "dungeon/montCouronne-3", True, False, True, True)
MONTCOURONNE_SALLE2.setEncounterTables(encounter.MONTCOURONNE_SALLE2)
MONTCOURONNE_EXTERIEUR1 = Zone("Mont Couronné - Extérieur 1", 211, "dungeon/montCouronne-4", False, True, False, False)
MONTCOURONNE_EXTERIEUR1.setEncounterTables(encounter.MONTCOURONNE_EXTERIEUR)
MONTCOURONNE_EXTERIEUR2 = Zone("Mont Couronné - Extérieur 2", 210, "dungeon/montCouronne-6", False, True, False, False)
MONTCOURONNE_EXTERIEUR2.setEncounterTables(encounter.MONTCOURONNE_EXTERIEUR)
MONTCOURONNE_SALLE3 = Zone("Mont Couronné - Salle 3", 212, "dungeon/montCouronne-5", True, False, True, True)
MONTCOURONNE_SALLE3.setEncounterTables(encounter.MONTCOURONNE_SALLE3)
MONTCOURONNE_SALLE4 = Zone("Mont Couronné - Salle 4", 213, "dungeon/montCouronne-7", True, False, True, True)
MONTCOURONNE_SALLE4.setEncounterTables(encounter.MONTCOURONNE_SALLE4)
MONTCOURONNE_SALLE5 = Zone("Mont Couronné - Salle 5", 214, "dungeon/montCouronne-8", True, False, True, True)
MONTCOURONNE_SALLE5.setEncounterTables(encounter.MONTCOURONNE_SALLE5)
MONTCOURONNE_SALLE6 = Zone("Mont Couronné - Salle 6", 215, "dungeon/montCouronne-9", True, False, True, True)
MONTCOURONNE_SALLE6.setEncounterTables(encounter.MONTCOURONNE_SALLE6)
MONTCOURONNE_SALLE7 = Zone("Mont Couronné - Salle 7", 216, "dungeon/montCouronne-10", True, False, True, True)
MONTCOURONNE_SALLE7.setEncounterTables(encounter.MONTCOURONNE_SALLE7)
MONTCOURONNE_PASSAGEVESTIGION = Zone("Mont Couronné - Passage Vestigion", 218, "dungeon/montCouronne-11", True, False, True, True)
MONTCOURONNE_PASSAGEVESTIGION.setEncounterTables(encounter.MONTCOURONNE_PASSAGEVESTIGION)
MONTCOURONNE_SALLE8 = Zone("Mont Couronné - Salle 8", 219, "dungeon/montCouronne-12", True, False, True, True)
MONTCOURONNE_SALLE8.setEncounterTables(encounter.MONTCOURONNE_SALLE8)
MONTCOURONNE_PASSAGEFRIMAPIC = Zone("Mont Couronné - Passage Frimapic", 217, "dungeon/montCouronne-13", True, False, True, True)
MONTCOURONNE_PASSAGEFRIMAPIC.setEncounterTables(encounter.MONTCOURONNE_PASSAGEFRIMAPIC)
MONTCOURONNE_GROTTEREGICE = Zone("Mont Couronné - Grotte Regice", 589, "dungeon/grotteRegi", True, False, True, True)
SALLEORIGINELLE = Zone("Salle Originelle", 510, "dungeon/salleOriginelle", False, False, False, False)
COLONNESLANCES = Zone("Colonnes Lances", 584, "dungeon/colonnesLances", False, False, False, False)
...
MANOIRPOKEMON_BUREAU = Zone("Manoir Pokémon - Bureau Décorum", 370, "route/manoirPokemon-2", False, False, False, False)
JARDINTROPHEE = Zone("Jardin Trophée", 287, "route/jardinTrophee", True, True, False, False)
...
# Grand Marais
VERCHAMPS_OBSERVATOIRE = Zone("Observatoire", 125, "city/verchamps-observatoire-1", False, False, False, False)
VERCHAMPS_OBSERVATOIRE_ETAGE1 = Zone("Observatoire - Étage 1", 126, "city/verchamps-observatoire-2", False, False, False, False)
GRANDMARAIS = Zone("Grand Marais", GRANDMARAIS_ID, "route/grandMarais", True, False, False, False)
...
# Ile de Fer
ILEDEFER = Zone("Ile de Fer", 288, "dungeon/ileDeFer-1", True, True, False, False)
ILEDEFER.setEncounterTables(encounter.ILEDEFER)
ILEDEFER_REZDECHAUSSEE = Zone("Ile de Fer - Rez-de-Chaussée", 289, "dungeon/ileDeFer-2", True, False, True, True)
ILEDEFER_REZDECHAUSSEE.setEncounterTables(encounter.ILEDEFER_REZDECHAUSSEE)
ILEDEFER_SOUSSOL1OUEST = Zone("Ile de Fer - Sous-Sol 1 Ouest", 290, "dungeon/ileDeFer-3", True, False, True, True)
ILEDEFER_SOUSSOL1OUEST.setEncounterTables(encounter.ILEDEFER_SOUSSOL1)
ILEDEFER_SOUSSOL1EST = Zone("Ile de Fer - Sous-Sol 1 Est", 291, "dungeon/ileDeFer-4", True, False, True, True)
ILEDEFER_SOUSSOL1EST.setEncounterTables(encounter.ILEDEFER_SOUSSOL1)
ILEDEFER_SOUSSOL2EST = Zone("Ile de Fer - Sous-Sol 2 Est", 292, "dungeon/ileDeFer-5", True, False, True, True)
ILEDEFER_SOUSSOL2EST.setEncounterTables(encounter.ILEDEFER_SOUSSOL2)
ILEDEFER_SOUSSOL2OUEST = Zone("Ile de Fer - Sous-Sol 2 Ouest", 293, "dungeon/ileDeFer-6", True, False, True, True)
ILEDEFER_SOUSSOL2OUEST.setEncounterTables(encounter.ILEDEFER_SOUSSOL2)
ILEDEFER_GROTTEREGISTEEL = Zone("Ile de Fer - Grotte Registeel", 587, "dungeon/grotteRegi", True, False, True, True)
ILEDEFER_SORTIE = Zone("Ile de Fer - Sortie", 294, "dungeon/ileDeFer-7", True, False, True, True)
...
# Temple Frimapic
TEMPLEFRIMAPIC_ENTREE = Zone("Temple Frimapic - Entrée", 278, "dungeon/templeFrimapic-1", True, False, True, True)
TEMPLEFRIMAPIC_ENTREE.setEncounterTables(encounter.TEMPLEFRIMAPIC_ENTREE)
TEMPLEFRIMAPIC_SOUSSOL1 = Zone("Temple Frimapic - Sous-Sol 1", 279, "dungeon/templeFrimapic-2", True, False, True, True)
TEMPLEFRIMAPIC_SOUSSOL1.setEncounterTables(encounter.TEMPLEFRIMAPIC_SOUSSOL1)
TEMPLEFRIMAPIC_SOUSSOL2 = Zone("Temple Frimapic - Sous-Sol 2", 280, "dungeon/templeFrimapic-3", True, False, True, True)
TEMPLEFRIMAPIC_SOUSSOL2.setEncounterTables(encounter.TEMPLEFRIMAPIC_SOUSSOL23)
TEMPLEFRIMAPIC_SOUSSOL3 = Zone("Temple Frimapic - Sous-Sol 3", 281, "dungeon/templeFrimapic-4", True, False, True, True)
TEMPLEFRIMAPIC_SOUSSOL3.setEncounterTables(encounter.TEMPLEFRIMAPIC_SOUSSOL23)
TEMPLEFRIMAPIC_SOUSSOL4 = Zone("Temple Frimapic - Sous-Sol 4", 282, "dungeon/templeFrimapic-5", True, False, True, True)
TEMPLEFRIMAPIC_SOUSSOL4.setEncounterTables(encounter.TEMPLEFRIMAPIC_SOUSSOL45)
TEMPLEFRIMAPIC_SALLEREGIGIGAS = Zone("Temple Frimapic - Salle Regigias", 283, "dungeon/templeFrimapic-6", True, False, True, True)
...
# Route Victoire
ROUTEVICTOIRE = Zone("Route Victoire", 244, "dungeon/routeVictoire-1", True, False, True, True)
ROUTEVICTOIRE.setEncounterTables(encounter.ROUTEVICTOIRE)
ROUTEVICTOIRE_SALLEOUEST = Zone("Route Victoire - Salle Ouest", 245, "dungeon/routeVictoire-2", True, False, True, True)
ROUTEVICTOIRE_SALLEOUEST.setEncounterTables(encounter.ROUTEVICTOIRE_SALLEOUEST)
ROUTEVICTOIRE_SALLEEST = Zone("Route Victoire - Salle Est", 246, "dungeon/routeVictoire-3", True, False, True, True)
ROUTEVICTOIRE_SALLEEST.setEncounterTables(encounter.ROUTEVICTOIRE_SALLEEST)
ROUTEVICTOIRE_SALLEBRUME = Zone("Route Victoire - Salle Brume", 247, "dungeon/routeVictoire-5", True, False, True, True)
ROUTEVICTOIRE_SALLEBRUME.setEncounterTables(encounter.ROUTEVICTOIRE_SALLEBRUME)
ROUTEVICTOIRE_PASSAGEEST = Zone("Route Victoire - Passage Est", 248, "dungeon/routeVictoire-4", True, False, True, True)
ROUTEVICTOIRE_PASSAGEEST.setEncounterTables(encounter.ROUTEVICTOIRE_PASSAGEEST)
ROUTEVICTOIRE_PASSAGEROUTE224 = Zone("Route Victoire - Passage Route 224", 249, "dungeon/routeVictoire-6", True, False, True, True)
...
SOURCEADIEU = Zone("Source Adieu", 267, "dungeon/sourceAdieu", True, True, False, False)
SOURCEADIEU.setEncounterTables(encounter.SOURCEADIEU)
GROTTERETOUR_ENTREE = Zone("Grotte Retour - Entrée", 268, "dungeon/grotteRetour-entree", True, False, False, True)
GROTTERETOUR_SALLEPILIER = Zone("Grotte Retour - Salle Pilier", 269, "dungeon/grotteRetour-pilier", True, False, False, True)
GROTTERETOUR_SALLEGIRATINA = Zone("Grotte Retour - Salle Giratina", 270, "dungeon/grotteRetour-giratina", True, False, False, True)
GROTTERETOUR_SALLE1 = Zone("Grotte Retour - Salle 1", 518, "dungeon/grotteRetour-1", True, False, False, True)
GROTTERETOUR_SALLE2 = Zone("Grotte Retour - Salle 2", 519, "dungeon/grotteRetour-2", True, False, False, True)
GROTTERETOUR_SALLE3 = Zone("Grotte Retour - Salle 3", 520, "dungeon/grotteRetour-3", True, False, False, True)
GROTTERETOUR_SALLE4 = Zone("Grotte Retour - Salle 4", 521, "dungeon/grotteRetour-4", True, False, False, True)
GROTTERETOUR_SALLE5 = Zone("Grotte Retour - Salle 5", 522, "dungeon/grotteRetour-5", True, False, False, True)
GROTTERETOUR_SALLE6 = Zone("Grotte Retour - Salle 6", 523, "dungeon/grotteRetour-6", True, False, False, True)
GROTTERETOUR_SALLE7 = Zone("Grotte Retour - Salle 7", 524, "dungeon/grotteRetour-7", True, False, False, True)
GROTTERETOUR_SALLE8 = Zone("Grotte Retour - Salle 8", 525, "dungeon/grotteRetour-8", True, False, False, True)
GROTTERETOUR_SALLE9 = Zone("Grotte Retour - Salle 9", 526, "dungeon/grotteRetour-9", True, False, False, True)
GROTTERETOUR_SALLE10 = Zone("Grotte Retour - Salle 10", 527, "dungeon/grotteRetour-10", True, False, False, True)
GROTTERETOUR_SALLE11 = Zone("Grotte Retour - Salle 11", 528, "dungeon/grotteRetour-11", True, False, False, True)
GROTTERETOUR_SALLE12 = Zone("Grotte Retour - Salle 12", 529, "dungeon/grotteRetour-12", True, False, False, True)
GROTTERETOUR_SALLE13 = Zone("Grotte Retour - Salle 13", 530, "dungeon/grotteRetour-13", True, False, False, True)
GROTTERETOUR_SALLE14 = Zone("Grotte Retour - Salle 14", 531, "dungeon/grotteRetour-14", True, False, False, True)
GROTTERETOUR_SALLE15 = Zone("Grotte Retour - Salle 15", 532, "dungeon/grotteRetour-15", True, False, False, True)
GROTTERETOUR_SALLE41 = Zone("Grotte Retour - Salle 41", 271, "dungeon/grotteRetour-41", True, False, False, True)
GROTTERETOUR_SALLE42 = Zone("Grotte Retour - Salle 42", 272, "dungeon/grotteRetour-42", True, False, False, True)
GROTTERETOUR_SALLE43 = Zone("Grotte Retour - Salle 43", 273, "dungeon/grotteRetour-43", True, False, False, True)
...
MONTABRUPT_SALLE1 = Zone("Mont Abrupt - Salle 1", 263, "dungeon/montAbrupt-1", True, False, True, True)
MONTABRUPT_SALLE1.setEncounterTables(encounter.MONTABRUPT_SALLE1)
MONTABRUPT_SALLE2 = Zone("Mont Abrupt - Salle 2", 264, "dungeon/montAbrupt-2", True, False, True, True)
MONTABRUPT_SALLE2.setEncounterTables(encounter.MONTABRUPT_SALLE2)
MONTABRUPT_SALLEHEATRAN = Zone("Mont Abrupt - Salle Heatran", 265, "dungeon/montAbrupt-3", True, False, False, True)
...
# Lac Vérité
LACVERITE = Zone("Lac Vérité", 312, "dungeon/lacVérité", True, True, False, False)
LACVERITE.setEncounterTables(encounter.LACVERITE)
LACVERITE_CAVERNEVERITE = Zone("Lac Vérité - Caverne Vérité", 313, "dungeon/caverneVerite", True, False, False, True)
...
# Lac Courage
LACCOURAGE = Zone("Lac Courage", 315, "dungeon/lacCourage", True, True, False, False)
LACCOURAGE.setEncounterTables(encounter.LACCOURAGE)
LACCOURAGE_CAVERNECOURAGE = Zone("Lac Courage - Caverne Courage", 316, "dungeon/caverneCourage", True, False, False, True)
...
# Lac Savoir
LACSAVOIR = Zone("Lac Savoir", 318, "dungeon/lacSavoir", False, True, False, False)
LACSAVOIR.setEncounterTables(encounter.LACSAVOIR)
LACSAVOIR_CAVERNESAVOIR = Zone("Lac Savoir - Caverne Savoir", 319, "dungeon/caverneSavoir", True, False, False, True)
...
# Grottes Légendaires
ROUTE228_GROTTEREGIROCK = Zone("Route 228 - Grotte Regirock", 591, "dungeon/grotteRegi", True, False, True, True)
...
# Ile Nouvellune
ILENOUVELLUNE = Zone("Ile Nouvellune", 320, "dungeon/ileNouvellune-1", False, False, False, False)
ILENOUVELLUNE_INTERIEUR = Zone("Ile Nouvellune - Intérieur", 321, "dungeon/ileNouvellune-2", False, False, False, False)
...
# Ile Pleine Lune
ILEPLEINELUNE = Zone("Ile Pleine Lune", 260, "dungeon/ilePleineLune-1", False, False, False, False)
ILEPLEINELUNE_INTERIEUR = Zone("Ile Pleine Lune - Intérieur", 261, "dungeon/ilePleineLune-2", False, False, False, False)
...
RESTAURANTSEPTETOILES = Zone("Restaurant 7 Étoiles", 337, "route/restaurantSeptEtoiles", False, False, False, False)
CAFECABANE = Zone("Café Cabane", 492, "route/cafeCabane", False, False, False, False)
ROUTE210_MAISON = Zone("Route 210 - Maison", 364, "route/route210-maison", False, False, False, False)
ROUTE212_MAISON = Zone("Route 212 - Maison", 372, "route/route212-maison", False, False, False, False)
ROUTE216_MAISON = Zone("Route 216 - Maison", 384, "route/route216-maison", False, False, False, False)
ROUTE217_MAISON = Zone("Route 217 - Maison", 386, "route/route217-maison", False, False, False, False)
ROUTE225_MAISON = Zone("Route 225 - Maison", 498, "route/route226-maison", False, False, False, False)
ROUTE226_MAISON = Zone("Route 226 - Maison", 499, "route/route226-maison", False, False, False, False)
ROUTE227_MAISON = Zone("Route 227 - Maison", 500, "route/route227-maison", False, False, False, False)
ROUTE228_MAISON1 = Zone("Route 227 - Maison 1", 502, "route/route228-maison2", False, False, False, False)
ROUTE228_MAISON2 = Zone("Route 227 - Maison 2", 503, "route/route228-maison2", False, False, False, False)
...
ZONEDICTIONARY = {
    "PL": {
        ...
        152: RIVAMAR_CENTREPOKEMON_ETAGE,
        153: RIVAMAR_SHOP,
        165: NORTH, # Frimapic
        166: FRIMAPIC_SHOP,
        ...
        190: AIREDECOMBAT_CENTREPOKEMON_ETAGE,
        ...
        492: CAFECABANE,
        495: LIGUEPOKEMON_INTERIEUR_ETAGE,
        498: ROUTE225_MAISON,
        499: ROUTE226_MAISON,
        500: ROUTE227_MAISON,
...
CITY_LIST = {
    "PL": {
        "Bonaugure": City("Bonaugure", 411,[[2,21]], ZONEDICTIONARY["PL"][SOUTHWEST.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][BONAUGURE_MAISON.zoneId])),
        "Littorella": City("Littorella", 418, [[4,20]], ZONEDICTIONARY["PL"][SOUTHWEST.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][LITTORELLA_CENTREPOKEMON.zoneId])),
        "Féli-Cité": City("Féli-Cité", 3, [[3,17],[4,17],[3,18],[4,18]], ZONEDICTIONARY["PL"][SOUTHWEST.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][FELICITE_CENTREPOKEMON.zoneId])),
        "Charbourg": City("Charbourg", 45, [[7,17],[8,17],[8,18]], ZONEDICTIONARY["PL"][SOUTHCENTER.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][CHARBOURG_CENTREPOKEMON.zoneId])),
        "Floraville": City("Floraville", 426, [[4,13],[4,14]], ZONEDICTIONARY["PL"][NORTHWEST.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][FLORAVILLE_CENTREPOKEMON.zoneId])),
        "Vestigion": City("Vestigion", 65, [[8,10],[9,10],[8,11]], ZONEDICTIONARY["PL"][NORTHWEST.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][VESTIGION_CENTREPOKEMON.zoneId])),
        "Unionpolis": City("Unionpolis", 86, [[13,15],[14,15],[13,16],[14,16]], ZONEDICTIONARY["PL"][UNIONPOLIS.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][UNIONPOLIS_CENTREPOKEMON.zoneId])),
        "Bonville": City("Bonville", 433, [[16,14],[17,14]], ZONEDICTIONARY["PL"][NORTHCENTER.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][BONVILLE_CENTREPOKEMON.zoneId])),
        "Voilaroc": City("Voilaroc", 132, [[20,12],[21,12],[20,13],[21,13]], ZONEDICTIONARY["PL"][VOILAROC.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][VOILAROC_CENTREPOKEMON.zoneId])),
        "Verchamps": City("Verchamps", 120, [[17,19],[18,19],[17,20],[18,20]], ZONEDICTIONARY["PL"][SOUTH.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][VERCHAMPS_CENTREPOKEMON.zoneId])),
        "Célestia": City("Célestia", 442, [[13,10]], ZONEDICTIONARY["PL"][NORTHCENTER.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][CELESTIA_CENTREPOKEMON.zoneId])),
        "Joliberges": City("Joliberges", 33, [[0,16],[0,17]], ZONEDICTIONARY["PL"][JOLIBERGES.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][JOLIBERGES_CENTREPOKEMON.zoneId])),
        "Frimapic": City("Frimapic", 165, [[10,0],[10,1]], ZONEDICTIONARY["PL"][NORTH.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][FRIMAPIC_CENTREPOKEMON.zoneId])),
        "Rivamar": City("Rivamar", 150, [[25,17],[26,17],[25,18],[26,18]], ZONEDICTIONARY["PL"][EAST.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][RIVAMAR_CENTREPOKEMON.zoneId])),
        "Route Victoire": City("Route Victoire", 172, [[25,12]], ZONEDICTIONARY["PL"][EAST.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][LIGUEPOKEMON_CENTREPOKEMON.zoneId])),
        "Ligue Pokémon": City("Ligue Pokémon", 172, [[25,11]], ZONEDICTIONARY["PL"][EAST.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][LIGUEPOKEMON_INTERIEUR.zoneId])),
        "Parc des Amis": City("Parc des Amis", 392, [[8,22]], ZONEDICTIONARY["PL"][SOUTHWEST.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][PARCDESAMIS.zoneId])),
        "Aire de Combat": City("Aire de Combat", 188, [[18,7],[19,7]], ZONEDICTIONARY["PL"][SECTEURCOMBAT_SOUTHEAST.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][AIREDECOMBAT_CENTREPOKEMON.zoneId])),
        "Aire de Survie": City("Aire de Survie", 450, [[19,4]], ZONEDICTIONARY["PL"][SECTEURCOMBAT_NORTHWEST.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][AIREDESURVIE_CENTREPOKEMON.zoneId])),
        "Aire de Détente": City("Aire de Détente", 457, [[24,8]], ZONEDICTIONARY["PL"][SECTEURCOMBAT_SOUTHEAST.zoneId].getDoorByDestination(ZONEDICTIONARY["PL"][AIREDEDETENTE_CENTREPOKEMON.zoneId]))
    },
    "DP": {
        "Bonaugure": City("Bonaugure", 411,[[2,21]], ZONEDICTIONARY["DP"][SOUTHWEST.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][BONAUGURE_MAISON.zoneId])),
        "Littorella": City("Littorella", 418, [[4,20]], ZONEDICTIONARY["DP"][SOUTHWEST.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][LITTORELLA_CENTREPOKEMON.zoneId])),
        "Féli-Cité": City("Féli-Cité", 3, [[3,17],[4,17],[3,18],[4,18]], ZONEDICTIONARY["DP"][SOUTHWEST.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][FELICITE_CENTREPOKEMON.zoneId])),
        "Charbourg": City("Charbourg", 45, [[7,17],[8,17],[8,18]], ZONEDICTIONARY["DP"][SOUTHCENTER.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][CHARBOURG_CENTREPOKEMON.zoneId])),
        "Floraville": City("Floraville", 426, [[4,13],[4,14]], ZONEDICTIONARY["DP"][NORTHWEST.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][FLORAVILLE_CENTREPOKEMON.zoneId])),
        "Vestigion": City("Vestigion", 65, [[8,10],[9,10],[8,11]], ZONEDICTIONARY["DP"][NORTHWEST.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][VESTIGION_CENTREPOKEMON.zoneId])),
        "Unionpolis": City("Unionpolis", 86, [[13,15],[14,15],[13,16],[14,16]], ZONEDICTIONARY["DP"][UNIONPOLIS.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][UNIONPOLIS_CENTREPOKEMON.zoneId])),
        "Bonville": City("Bonville", 433, [[16,14],[17,14]], ZONEDICTIONARY["DP"][NORTHCENTER.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][BONVILLE_CENTREPOKEMON.zoneId])),
        "Voilaroc": City("Voilaroc", 132, [[20,12],[21,12],[20,13],[21,13]], ZONEDICTIONARY["DP"][VOILAROC.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][VOILAROC_CENTREPOKEMON.zoneId])),
        "Verchamps": City("Verchamps", 120, [[17,19],[18,19],[17,20],[18,20]], ZONEDICTIONARY["DP"][SOUTH.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][VERCHAMPS_CENTREPOKEMON.zoneId])),
        "Célestia": City("Célestia", 442, [[13,10]], ZONEDICTIONARY["DP"][NORTHCENTER.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][CELESTIA_CENTREPOKEMON.zoneId])),
        "Joliberges": City("Joliberges", 33, [[0,16],[0,17]], ZONEDICTIONARY["DP"][JOLIBERGES.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][JOLIBERGES_CENTREPOKEMON.zoneId])),
        "Frimapic": City("Frimapic", 165, [[10,0],[10,1]], ZONEDICTIONARY["DP"][NORTH.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][FRIMAPIC_CENTREPOKEMON.zoneId])),
        "Rivamar": City("Rivamar", 150, [[25,17],[26,17],[25,18],[26,18]], ZONEDICTIONARY["DP"][EAST.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][RIVAMAR_CENTREPOKEMON.zoneId])),
        "Ligue Pokémon": City("Ligue Pokémon", 172, [[25,11]], ZONEDICTIONARY["DP"][EAST.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][LIGUEPOKEMON_INTERIEUR.zoneId])),
        "Parc des Amis": City("Parc des Amis", 392, [[8,22]], ZONEDICTIONARY["DP"][SOUTHWEST.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][PARCDESAMIS.zoneId])),
        "Aire de Combat": City("Aire de Combat", 188, [[18,7],[19,7]], ZONEDICTIONARY["DP"][SECTEURCOMBAT_SOUTHEAST.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][AIREDECOMBAT_CENTREPOKEMON.zoneId])),
        "Aire de Survie": City("Aire de Survie", 450, [[19,4]], ZONEDICTIONARY["DP"][SECTEURCOMBAT_NORTHWEST.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][AIREDESURVIE_CENTREPOKEMON.zoneId])),
        "Aire de Détente": City("Aire de Détente", 457, [[24,8]], ZONEDICTIONARY["DP"][SECTEURCOMBAT_SOUTHEAST.zoneId].getDoorByDestination(ZONEDICTIONARY["DP"][AIREDEDETENTE_CENTREPOKEMON.zoneId]))
    }
}
...
OBSOLETEDOORS = [
    ...
    Door(WALK, Position(181,613,NORTHWEST), Position(51,10,PREFLORAVILLE)),
    Door(DEFAULT, Position(51,9,PREFLORAVILLE), Position(181,612,NORTHWEST)),
    Door(DEFAULT, Position(163,641,NORTHWEST), Position(13,54,PREFLORAVILLE)),
    Door(WALK, Position(13,55,PREFLORAVILLE), Position(163,642,NORTHWEST)),
