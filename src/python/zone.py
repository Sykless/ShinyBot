...
# Bonaugure
BONAUGURE_MAISON = Zone("Bonaugure - Maison Maman", 414, "city/bonaugure-maisonMaman", False, False)
...
# Parc des Amis
PARCDESAMIS = Zone("Parc des Amis", 393, "city/parcdesamis", False, False)
...
# Ruines Bonville
RUINESBONVILLE_ENTREE = Zone("Ruines Bonville - Entrée", 226, "dungeon/ruinesBonville-1", True, False)
RUINESBONVILLE_ENTREE_NORDOUEST = Zone("Ruines Bonville - Entrée Nord-Ouest", 228, "dungeon/ruinesBonville-2", True, False)
RUINESBONVILLE_ENTREE_SUDEST = Zone("Ruines Bonville - Entrée Sud-Est", 230, "dungeon/ruinesBonville-3", True, False)
RUINESBONVILLE_SALLE1 = Zone("Ruines Bonville - Salle 1", 229, "dungeon/ruinesBonville-4", True, False)
RUINESBONVILLE_SALLE1_NORDEST = Zone("Ruines Bonville - Salle 1 Nord-Est", 227, "dungeon/ruinesBonville-5", True, False)
RUINESBONVILLE_SALLE1_SUDEST = Zone("Ruines Bonville - Salle 1 Sud-Est", 232, "dungeon/ruinesBonville-6", True, False)
RUINESBONVILLE_SALLE2 = Zone("Ruines Bonville - Salle 2", 231, "dungeon/ruinesBonville-7", True, False)
RUINESBONVILLE_SALLE2_NORDOUEST = Zone("Ruines Bonville - Salle 2 Nord-Ouest", 235, "dungeon/ruinesBonville-8", True, False)
RUINESBONVILLE_SALLE2_SUDOUEST = Zone("Ruines Bonville - Salle 2 Sud-Ouest", 236, "dungeon/ruinesBonville-9", True, False)
RUINESBONVILLE_SALLE3 = Zone("Ruines Bonville - Salle 3", 237, "dungeon/ruinesBonville-10", True, False)
RUINESBONVILLE_SALLE3_SUDEST = Zone("Ruines Bonville - Salle 3 Sud-Est", 241, "dungeon/ruinesBonville-11", True, False)
RUINESBONVILLE_SALLE4 = Zone("Ruines Bonville - Salle 4", 239, "dungeon/ruinesBonville-12", True, False)
RUINESBONVILLE_SALLE4_SUDOUEST = Zone("Ruines Bonville - Salle 4 Sud-Ouest", 234, "dungeon/ruinesBonville-13", True, False)
RUINESBONVILLE_SALLE4_SUDEST = Zone("Ruines Bonville - Salle 4 Sud-Est", 515, "dungeon/ruinesBonville-14", True, False)
RUINESBONVILLE_SALLE5 = Zone("Ruines Bonville - Salle 5", 238, "dungeon/ruinesBonville-15", True, False)
RUINESBONVILLE_SALLE5_NORDOUEST = Zone("Ruines Bonville - Salle 5 Nord-Ouest", 242, "dungeon/ruinesBonville-16", True, False)
RUINESBONVILLE_SALLE5_SUDEST = Zone("Ruines Bonville - Salle 5 Sud-Est", 233, "dungeon/ruinesBonville-17", True, False)
RUINESBONVILLE_SALLE6 = Zone("Ruines Bonville - Salle 6", 240, "dungeon/ruinesBonville-18", True, False)
...
# Tunnel Ruinemaniac
TUNNELRUINEMANIAC = Zone("Tunnel Ruinemaniac", 513, "dungeon/tunnelRuinemaniac", True, False)
RUINESBONVILLE_SALLE7 = Zone("Ruines Bonville - Salle 7", 225, "dungeon/ruinesBonville-19", True, False)
...
# Manoir Pokémon
MANOIRPOKEMON = Zone("Manoir Pokémon", 368, "route/manoirPokemon-1", False, False)
MANOIRPOKEMON_BUREAU = Zone("Manoir Pokémon - Bureau Décorum", 370, "route/manoirPokemon-2", False, False)
JARDINTROPHEE = Zone("Jardin Trophée", 287, "route/jardinTrophee", True, True)
...
RESTAURANTSEPTETOILES = Zone("Restaurant 7 Étoiles", 337, "route/restaurantSeptEtoiles", False, False)
CAFECABANE = Zone("Café Cabane", 492, "route/cafeCabane", False, False)
ROUTE210_MAISON = Zone("Route 210 - Maison", 364, "route/route210-maison", False, False)
ROUTE212_MAISON = Zone("Route 212 - Maison", 372, "route/route212-maison", False, False)
ROUTE216_MAISON = Zone("Route 216 - Maison", 384, "route/route216-maison", False, False)
ROUTE217_MAISON = Zone("Route 217 - Maison", 386, "route/route217-maison", False, False)
ROUTE225_MAISON = Zone("Route 225 - Maison", 498, "route/route226-maison", False, False)
ROUTE226_MAISON = Zone("Route 226 - Maison", 499, "route/route226-maison", False, False)
ROUTE227_MAISON = Zone("Route 227 - Maison", 500, "route/route227-maison", False, False)
ROUTE228_MAISON1 = Zone("Route 227 - Maison 1", 502, "route/route228-maison2", False, False)
ROUTE228_MAISON2 = Zone("Route 227 - Maison 2", 503, "route/route228-maison2", False, False)
...
ZONELIST = [
    ...
    HOTELGRANDLAC, PISTECYCLABLE, MANOIRPOKEMON, MANOIRPOKEMON_BUREAU, JARDINTROPHEE, RESTAURANTSEPTETOILES, CAFECABANE,
